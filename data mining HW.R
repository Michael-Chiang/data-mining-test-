...
##£g{|!RM¢Do ->  |w¡ME£g{|!RM¢Do -> Taiwan(Taipei) -> ?i asbio
library(asbio)
one.sample.z(score, null.mu =60, sigma =4.8,alternative="two.sided") #3a?E¢D?zAEcw
one.sample.t(score, null.mu =60, alternative="two.sided",conf = 0.95) #3a?E¢D?tAEcw